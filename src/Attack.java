...
public class Attack{
	/*
	 * class that represents each attack. Each time a player or monster attacks,
	 * this class is instantiated and an attack with a strength, direction and image is placed on the board
	 */
